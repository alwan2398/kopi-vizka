...
const Banner = () => {
  return (
    <>
      <span id="about"></span>
      <div style={bgImage}>
        <div className="contanier min-h-[550px] flex justify-center items-center py-12 sm:py-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
              ...
              >
                Premium Coffee Disini
              </h1>
              <p
                data-aos="fade-up"
                className="text-sm text-gray-500 tracking-wide leading-5"
              >
                Mari sambut kelezatan kopi sejati dengan biji-biji terbaik dari
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-500 text-sm">
                    Segera temukan pengalaman kopi yang luar biasa dengan
                    koleksi premium kami. Bersiaplah untuk menjelajahi dunia
                    rasa yang mengagumkan dan kualitas yang tiada tanding,
                  </p>
                </div>
              </div>
            </div>
